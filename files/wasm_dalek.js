...
* @returns {Uint8Array}
*/
export function gen_signature(kp, message) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray8ToWasm0(kp, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passArray8ToWasm0(message, wasm.__wbindgen_malloc);
        const len1 = WASM_VECTOR_LEN;
        wasm.gen_signature(retptr, ptr0, len0, ptr1, len1);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
...
* @returns {boolean}
*/
export function signature_verifies(pubkey, sig, msg) {
    ...
    const ret = wasm.signature_verifies(ptr0, len0, ptr1, len1, ptr2, len2);
    return ret !== 0;
}
...
* @returns {Uint8Array}
*/
export function pubkey_from_pair(kp) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray8ToWasm0(kp, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.pubkey_from_pair(retptr, ptr0, len0);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
...
* @returns {Uint8Array}
*/
export function pubkey_from_bytes(pubkey) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray8ToWasm0(pubkey, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.pubkey_from_bytes(retptr, ptr0, len0);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var v1 = getArrayU8FromWasm0(r0, r1).slice();
        wasm.__wbindgen_free(r0, r1 * 1);
...
function getImports() {
    ...
    imports.wbg.__wbg_crypto_71b946c90b06fb5b = function() { return handleError(function (arg0) {
    ...
    imports.wbg.__wbg_getRandomValues_2a91ccd2d6c499b0 = function() { return handleError(function (arg0, arg1, arg2) {
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('wasm_dalek_bg.wasm', import.meta.url);
    }
    const imports = getImports();
